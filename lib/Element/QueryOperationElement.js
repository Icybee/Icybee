!function(Brickrouge) {
	...
	Brickrouge.Widget.QueryOperation = new Class({
		...
		start: function()
		{
			...
			, iterator = null
			, params = this.element.getElement('form').toQueryString()
	...
	Brickrouge.register('Progress', function (element, options) {

		return new Brickrouge.Widget.Progress(element, options)

	})

	Brickrouge.register('QueryOperation', function (element, options) {

		return new Brickrouge.Widget.QueryOperation(element, options)
