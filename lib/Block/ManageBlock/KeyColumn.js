...
window.addEvent('icybee.manageblock.ready', function(manager) {
	 ...
	 */
	manager.element.addEvents({

		'click:relay(.listview thead .cell-key input)': function(ev, el) {
		 ...
		 */
		'click:relay(.listview tbody .cell-key input)': change,

		/**
		 * Toogle a checkbox when its parent TR is clicked.
		 */
		'click:relay(.listview tbody tr)': function(ev, el) {
